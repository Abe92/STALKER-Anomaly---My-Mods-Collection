...
#define GM_DIFF_INT 0.5 //Diffuse cracks intensity
#define GM_VIG_INT 1.0 //Vignette intensity
...
#define GM_VIS_RADIUS 0.5 //Reflection radius
#define GM_VIS_INTENSITY 0.9 //Reflection intensity
